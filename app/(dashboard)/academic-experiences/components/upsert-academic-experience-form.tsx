...
const UpsertAcademicExperienceForm = ({
  ...
  const getDefaultValues = (
    ...
    declarationUrl: academicExperience?.declarationUrl
      ...
      : [],
    modules: academicExperience?.modules?.map((module) => ({
      id: module.id,
      title: module.title,
      ...
      // Inicializar com um módulo vazio se não houver dados
      {
        title: "",
        iconUrl: [],
  ...
  const getTabValidationState = (tabId: string) => {
    ...
    const hasRequiredValues = fieldsToCheck.some((field) => {
      // Para documentos, todos são opcionais
      if (tabId === "documents") return true;
    ...
    if (hasRequiredValues) return "valid";
    return "empty";
  };
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-h-[95vh] max-w-6xl overflow-hidden">
        ...
        <div className="flex h-[calc(95vh-200px)] gap-6">
                      ...
                      <div className="rounded-lg bg-muted/50 p-4">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="text-sm text-muted-foreground">
                            ...
                            <p>
                              Os documentos são opcionais mas recomendados para
                              comprovar sua formação. Aceitos apenas arquivos
                              PDF. Certifique-se de que os documentos estejam
                              legíveis.
                            </p>
                          </div>
                        </div>
