...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex shrink-0 scale-[0.5] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:min-h-[200vh] md:scale-100 md:py-80 lg:py-64 xl:py-28"
    >
      <motion.h2
        style={{
